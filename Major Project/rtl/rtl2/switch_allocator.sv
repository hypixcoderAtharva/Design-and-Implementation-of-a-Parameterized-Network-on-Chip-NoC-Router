...
// a one-hot "input_granted_output" vector per input port plus the output
// VC each winning flit is using (for credit bookkeeping downstream).
// =============================================================================
...
#(
  ...
  output logic [NUM_PORTS-1:0]  input_granted_output [NUM_PORTS], // per input port
  output logic [VC_ID_W-1:0]    xbar_sel_vc          [NUM_PORTS]  // per output port
);
